        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form @submit.prevent="createProject">
              <input v-model="state.editable.name" type="text" class="form-control mb-3" placeholder="Project Name"
                aria-label="Example text with button addon" aria-describedby="button-addon1" />

              <input v-model="state.editable.description" type="text" class="form-control" placeholder="Project Body"
                aria-label="Example text with button addon" aria-describedby="button-addon1" />
              <div class="modal-footer">
                ...
                <button type="submit" @click.prevent="createProject" class="btn btn-primary" data-bs-target="#create"
                  data-bs-dismiss="modal">
                  Create
                </button>
              </div>
